...
function updateData(ind,mytitle,mynote) {
    downloadedData[ind].title=mytitle[ind].value;
    downloadedData[ind].noting=mynote[ind].value;
    localStorage.setItem("noteData", JSON.stringify(downloadedData));
}